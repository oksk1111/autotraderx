# ⛔ 공격적 Tick 매매 모드 (v6.0: 비활성화됨)

> **⚠️ 경고: 이 모드는 v6.0에서 비활성화되었습니다.**
> 
> 30만원 → 4만원 (87% 손실)의 주요 원인 중 하나였습니다.
> ML 신호만으로 검증 없이 매매하는 것은 손실을 키우는 핵심 요인이었습니다.
> 자세한 내용은 `docs/TRADING_V6_CONSERVATIVE.md` 참조.
